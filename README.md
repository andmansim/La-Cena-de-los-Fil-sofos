...
Mi dirección de GitHub para este repositorio es la siguiente: [GitHub](https://github.com/andmansim/La-Cena-de-los-Filosofos.git)
https://github.com/andmansim/La-Cena-de-los-Filosofos.git

El ejercicio al completo está en el fichero todo.py, también están las dos partes por separado: GUI: gui.py, Flósofos: ejercicio.py
# Todo.py
